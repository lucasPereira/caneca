...
public class CanecaSemanticoDefinicao extends TreeFilter {
    ...
    public final void iniciarConstrutor() throws RecognitionException {
        try {
            ...
            match(input,IDENTIFICADOR,FOLLOW_IDENTIFICADOR_in_iniciarConstrutor228); if (state.failed) return ;
    ...
    public final void iniciarDestrutor() throws RecognitionException {
        try {
            ...
            match(input,IDENTIFICADOR,FOLLOW_IDENTIFICADOR_in_iniciarDestrutor272); if (state.failed) return ;
    ...
    public final void terminarBloco() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
            			if (INSTRUCOES_5.hasAncestor(METODO_)) {
            				escopoAtual = escopoAtual.fechar();
            				filaDeEscopos.add(escopoAtual);
            			}
            		}
    ...
    public final void declaracao() throws RecognitionException {
        ...
        try {
            ...
            IDENTIFICADOR6=(CommonTree)match(input,IDENTIFICADOR,FOLLOW_IDENTIFICADOR_in_declaracao350); if (state.failed) return ;

            match(input, Token.UP, null); if (state.failed) return ;


            if ( state.backtracking==1 ) {
            			Variavel variavel = new Variavel((IDENTIFICADOR6!=null?IDENTIFICADOR6.getText():null), tipo7, IDENTIFICADOR6.getTokenStartIndex());
            			boolean definido = escopoAtual.definirVariavel(variavel);
            			reportarDefinicao(definido, (IDENTIFICADOR6!=null?IDENTIFICADOR6.getText():null), variavel, "variavel", IDENTIFICADOR6.getLine(), IDENTIFICADOR6.getCharPositionInLine());
    ...
    public final void declaracaoDeAtributo() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
            			Atributo atributo = new Atributo((IDENTIFICADOR8!=null?IDENTIFICADOR8.getText():null), tipo9);
            			boolean definido = escopoAtual.definirAtributo(atributo);
            			reportarDefinicao(definido, (IDENTIFICADOR8!=null?IDENTIFICADOR8.getText():null), atributo, "atributo", IDENTIFICADOR8.getLine(), IDENTIFICADOR8.getCharPositionInLine());
    ...
    public static final BitSet FOLLOW_IDENTIFICADOR_in_iniciarClasse132 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0xFFFFFFFFFFFFFFFFL});
    ...
    public static final BitSet FOLLOW_ESTATICO_in_iniciarMetodo178 = new BitSet(new long[]{0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_tipo_in_iniciarMetodo182 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_IDENTIFICADOR_in_iniciarMetodo184 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0xFFFFFFFFFFFFFFFFL});
    ...
    public static final BitSet FOLLOW_IDENTIFICADOR_in_iniciarConstrutor228 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0xFFFFFFFFFFFFFFFFL});
    ...
    public static final BitSet FOLLOW_IDENTIFICADOR_in_iniciarDestrutor272 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0xFFFFFFFFFFFFFFFFL});
    ...
    public static final BitSet FOLLOW_ESTATICO_in_declaracaoDeAtributo372 = new BitSet(new long[]{0x0000000000000000L,0x2000000000000000L});
    public static final BitSet FOLLOW_tipo_in_declaracaoDeAtributo376 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_IDENTIFICADOR_in_declaracaoDeAtributo378 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF8L,0xFFFFFFFFFFFFFFFFL});
    public static final BitSet FOLLOW_TIPO__in_tipo404 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENTIFICADOR_in_tipo406 = new BitSet(new long[]{0x0000000000000000L,0x0800000000000000L});
    ...
    public static final BitSet FOLLOW_tipo_in_listaDeTipos432 = new BitSet(new long[]{0x0000000000000008L,0x2000000000000000L});
